...
public class BackendClientInterfaceImp implements BackendClientInterface {
    ...
    public Result<String, BackendErrorResponse> registerCustomer(@NonNull BackendRegistrationReq req) {
        return webClient
            .post()
            .uri(USERS_URL)
    ...
    public Result<BackendRespUuid, BackendErrorResponse> getCustomerUuid(@NonNull String username) {
        return webClient
            .get()
    ...
    public Result<String, BackendErrorResponse> registerAccount(@NonNull AccountRegistrationReq req) {
    ...
    public Result<TransferResponse, BackendErrorResponse> transferMoney(@NonNull TransferRequest request) {
        return webClient
            .post()
